...
> 把网页中的图片和视频，一键整理成沉浸式全屏瀑布流。当前版本：**v1.9.8**。
...
- 新增站点适配中心，设置面板可查看当前站点命中的适配器、采集策略、分页进度和渲染队列。
- 强化会话恢复，刷新或重新打开后会恢复筛选、大图位置和滚动位置。
- 优化大量图片页面的打开和滚动流畅度，瀑布流改为分帧渲染并降低图片加载时的重排压力。
- 发布校验新增 README、CHANGELOG、扩展 manifest 和新增补丁加载检查，避免版本展示不一致。
