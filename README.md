...
- 设置面板补齐中文文案，速度设置显示为“极速/默认/较快/普通/慢速”。
- 1:1 原尺寸按当前屏幕 DPR 折算，连续点击尺寸保持一致，手机端也可正常进入 1:1。
- CloudDrive2 文件页增加 `data-path` 视频识别，能从 115 挂载目录构造可播放的视频地址。
- CloudDrive2 视频目录会自动切到“只看视频”，避免停在图片筛选时看不到视频。
