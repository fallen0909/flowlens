...
(() => {
  ...
  const css = `
    ...
    @media (max-width: 820px) { #xiv-topbar { justify-content: space-between !important; align-items:flex-start !important; gap: 6px !important; padding-right: max(8px, env(safe-area-inset-right, 0px)) !important; padding-left: max(8px, env(safe-area-inset-left, 0px)) !important; } #xiv-topbar .xiv-pill { display: inline-flex !important; } #xiv-topbar .xiv-actions { flex-wrap: wrap !important; justify-content:flex-end !important; max-width: min(268px, 62vw) !important; gap: 5px !important; } #xiv-topbar .xiv-btn { min-width: 36px !important; width: 36px !important; height: 36px !important; padding: 0 !important; } #xiv-topbar .xiv-btn span { display: none !important; } #xiv-root:has(#xiv-lightbox[data-active="true"]) #xiv-topbar .xiv-pill { max-width: calc(100vw - 252px) !important; min-height: 28px !important; padding: 0 !important; background: transparent !important; border: 0 !important; box-shadow: none !important; backdrop-filter: none !important; font-size: 12px !important; } #xiv-root:has(#xiv-lightbox[data-active="true"]) #xiv-topbar .xiv-actions { max-width: 244px !important; gap: 5px !important; } #xiv-root:has(#xiv-lightbox[data-active="true"]) #xiv-topbar .xiv-btn { min-width: 34px !important; width: 34px !important; height: 34px !important; } #xiv-stage { padding-top: calc(58px + env(safe-area-inset-top, 0px)) !important; } #xiv-lightbox img, #xiv-lightbox video { max-width: 100vw !important; max-height: 100dvh !important; } }
  `;
