...
(() => {
  ...
  const css = `
    ...
    @media (max-width: 820px) { #xiv-topbar { justify-content: space-between !important; align-items:flex-start !important; gap: 6px !important; padding-right: max(8px, env(safe-area-inset-right, 0px)) !important; padding-left: max(8px, env(safe-area-inset-left, 0px)) !important; } #xiv-topbar .xiv-pill { display: inline-flex !important; } #xiv-topbar .xiv-actions { flex-wrap: wrap !important; justify-content:flex-end !important; max-width: min(268px, 62vw) !important; gap: 5px !important; } #xiv-topbar .xiv-btn { min-width: 36px !important; width: 36px !important; height: 36px !important; } #xiv-stage { padding-top: calc(58px + env(safe-area-inset-top, 0px)) !important; } #xiv-lightbox img, #xiv-lightbox video { max-width: 100vw !important; max-height: 100dvh !important; } }
  `;
